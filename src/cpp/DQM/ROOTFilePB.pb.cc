...
namespace protobuf_DQM_2fROOTFilePB_2eproto {
...
void InitDefaultsROOTFilePBImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_DQM_2fROOTFilePB_2eproto::InitDefaultsROOTFilePB_Histo();
  {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "DQM/ROOTFilePB.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\024DQM/ROOTFilePB.proto\022\ndqmstorepb\"\216\001\n\nR"
      "OOTFilePB\022+\n\005histo\030\001 \003(\0132\034.dqmstorepb.RO"
      "OTFilePB.Histo\032S\n\005Histo\022\025\n\rfull_pathname"
      "\030\001 \002(\t\022\014\n\004size\030\002 \002(\r\022\026\n\016streamed_histo\030\003"
      " \002(\014\022\r\n\005flags\030\004 \002(\r"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 179);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "DQM/ROOTFilePB.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::Descriptor* ROOTFilePB_Histo::descriptor() {
  ::protobuf_DQM_2fROOTFilePB_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_DQM_2fROOTFilePB_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata ROOTFilePB_Histo::GetMetadata() const {
  protobuf_DQM_2fROOTFilePB_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_DQM_2fROOTFilePB_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
ROOTFilePB::ROOTFilePB()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_DQM_2fROOTFilePB_2eproto::InitDefaultsROOTFilePB();
  }
  SharedCtor();
