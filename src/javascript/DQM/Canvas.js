...
GUI.Plugin.DQMCanvas = new function () {
    ...
    this.setLinkMe = function () {
        ...
        xhr.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                _linkMe = Ext.MessageBox.show({
                    title: 'Cut and Paste this link:', msg: '',
    ...
    this.attach = function (gui) {
        ...
        var linkmeAction = new Ext.Action({
            text: 'Link-Me',
        ...
        _jsonDataButton = new Ext.Button({
            text: 'JSON data',
